...
const WORDS = [
  ...
  { kana: "かのじょ", romaji: "kanojo", en: "girlfriend / partner before marriage", group: "particles" },
  ...
  { kana: "ソフトウェアエンジニア", romaji: "sofutowea-enjinia", en: "software engineer", group: "particles" },
  { kana: "フィリピンじん", romaji: "firipin-jin", en: "Filipino person", group: "particles" },
  { kana: "にほんじん", romaji: "nihon-jin", en: "Japanese person", group: "particles" },
  { kana: "ハーフ", romaji: "haafu", en: "half / mixed heritage", group: "particles" },
  ...
  { kana: "しゅうまつ", romaji: "shuumatsu", en: "weekend", group: "particles" },
  { kana: "げつようび", romaji: "getsuyoubi", en: "Monday", group: "particles" },
  { kana: "くがつ", romaji: "kugatsu", en: "September", group: "particles" },
  ...
  { kana: "すきな", romaji: "suki-na", en: "favorite / liked", group: "particles", audio: "audio/particles/words/suki-na.mp3" },
  { kana: "こと", romaji: "koto", en: "activity / abstract thing", group: "particles", audio: "audio/particles/words/koto.mp3" },
  { kana: "もの", romaji: "mono", en: "thing / object", group: "particles", audio: "audio/particles/words/mono.mp3" },
  { kana: "そうなんですね", romaji: "sou-nan-desu-ne", en: "I see / oh, is that so? · formal", group: "conversation" },
  { kana: "そうなんだ", romaji: "sou-nan-da", en: "I see / oh, is that so? · casual", group: "conversation" },
  ...
  { kana: "いって", romaji: "itte", en: "go and... / te-form", group: "verbs" },
  { kana: "いきました", romaji: "ikimashita", en: "went · formal", group: "verbs" },
  { kana: "いった", romaji: "itta", en: "went · casual", group: "verbs" },
  { kana: "いきたいです", romaji: "ikitai-desu", en: "want to go · formal", group: "verbs" },
  { kana: "いきたい", romaji: "ikitai", en: "want to go · casual", group: "verbs" },
  ...
  { kana: "して", romaji: "shite", en: "do and... / te-form", group: "verbs" },
  { kana: "している", romaji: "shite-iru", en: "doing · casual", group: "verbs" },
  { kana: "してる", romaji: "shiteru", en: "doing · spoken casual", group: "verbs" },
  ...
  { kana: "べんきょうして", romaji: "benkyou-shite", en: "study and... / te-form", group: "verbs" },
  ...
  { kana: "たべる", romaji: "taberu", en: "to eat · casual", group: "verbs" },
  { kana: "たべます", romaji: "tabemasu", en: "to eat · formal", group: "verbs" },
  { kana: "たべて", romaji: "tabete", en: "eat and... / te-form", group: "verbs" },
  { kana: "たべている", romaji: "tabete-iru", en: "eating · casual", group: "verbs" },
  { kana: "たべてる", romaji: "tabeteru", en: "eating · spoken casual", group: "verbs" },
  { kana: "たべています", romaji: "tabete-imasu", en: "eating · formal", group: "verbs" },
  { kana: "たべました", romaji: "tabemashita", en: "ate · formal", group: "verbs" },
  { kana: "たべた", romaji: "tabeta", en: "ate · casual", group: "verbs" },
  { kana: "たべたいです", romaji: "tabetai-desu", en: "want to eat · formal", group: "verbs" },
  { kana: "たべたい", romaji: "tabetai", en: "want to eat · casual", group: "verbs" },
  ...
  { kana: "のんで", romaji: "nonde", en: "drink and... / te-form", group: "verbs" },
  { kana: "のんでいる", romaji: "nonde-iru", en: "drinking · casual", group: "verbs" },
  { kana: "のんでる", romaji: "nonderu", en: "drinking · spoken casual", group: "verbs" },
  { kana: "のんでいます", romaji: "nonde-imasu", en: "drinking · formal", group: "verbs" },
  { kana: "のみました", romaji: "nomimashita", en: "drank · formal", group: "verbs" },
  { kana: "のんだ", romaji: "nonda", en: "drank · casual", group: "verbs" },
  { kana: "のみたいです", romaji: "nomitai-desu", en: "want to drink · formal", group: "verbs" },
  { kana: "のみたい", romaji: "nomitai", en: "want to drink · casual", group: "verbs" },
  ...
  // dining out — restaurant service + table small talk (reflection set)
  { kana: "よる", romaji: "yoru", en: "night", group: "dining" },
  { kana: "そと", romaji: "soto", en: "outside", group: "dining" },
  { kana: "おそと", romaji: "osoto", en: "outside (polite)", group: "dining" },
  { kana: "てんない", romaji: "tennai", en: "inside the restaurant", group: "dining" },
  { kana: "なか", romaji: "naka", en: "inside", group: "dining" },
  { kana: "ごちゅうもん", romaji: "go chuumon", en: "order (polite)", group: "dining" },
  { kana: "おきまり", romaji: "okimari", en: "decided / ready to order", group: "dining" },
  { kana: "おきまりですか。", romaji: "okimari desu ka.", en: "Have you decided?", group: "dining" },
  { kana: "およびください。", romaji: "oyobi kudasai.", en: "Please call us / let us know", group: "dining" },
  { kana: "おいくつですか。", romaji: "oikutsu desu ka.", en: "How many? (items)", group: "dining" },
  { kana: "ふたつ、おねがいします。", romaji: "futatsu onegai shimasu.", en: "Two, please", group: "dining" },
  { kana: "シェアします。", romaji: "shea shimasu.", en: "We'll share", group: "dining" },
  { kana: "いじょうでよろしいですか。", romaji: "ijou de yoroshii desu ka.", en: "Is that all?", group: "dining" },
  { kana: "いじょうです。", romaji: "ijou desu.", en: "That's all", group: "dining" },
  { kana: "おねがいします。", romaji: "onegai shimasu.", en: "Please", group: "dining" },
  { kana: "おすみですか。", romaji: "osumi desu ka.", en: "Are you done?", group: "dining" },
  { kana: "ごちそうさまでした。", romaji: "gochisousama deshita.", en: "Thank you for the meal", group: "dining" },
  { kana: "おかいけいはどこですか。", romaji: "okaikei wa doko desu ka.", en: "Where is the checkout?", group: "dining" },
  { kana: "どこではらいますか。", romaji: "doko de haraimasu ka.", en: "Where do we pay?", group: "dining" },
  { kana: "たばこ", romaji: "tabako", en: "cigarettes / smoking", group: "dining" },
  { kana: "ごちゅうもんおきまりですか。", romaji: "go chuumon okimari desu ka.", en: "Have you decided on your order?", group: "dining" },
  { kana: "ちょっとまってください。", romaji: "chotto matte kudasai.", en: "Please wait a moment", group: "dining" },
  { kana: "まだです。", romaji: "mada desu.", en: "Not yet", group: "dining" },
  { kana: "コーラ", romaji: "koora", en: "cola / coke", group: "dining" },
  { kana: "サラダ", romaji: "sarada", en: "salad", group: "dining" },
  { kana: "ついか", romaji: "tsuika", en: "anything else? (extra order)", group: "dining" },
  { kana: "かいすう", romaji: "kaisuu", en: "number of checks / payments", group: "dining" },
  { kana: "いっかい", romaji: "ikkai", en: "once / one check", group: "dining" },
  { kana: "どこからきたの。", romaji: "doko kara kita no.", en: "Where are you from? (casual)", group: "dining" },
  { kana: "カナダしゅっしんです。", romaji: "canada shusshin desu.", en: "I'm from Canada", group: "dining" },
  { kana: "カナダからきました。", romaji: "canada kara kimashita.", en: "I came from Canada", group: "dining" },
  { kana: "にほんはどうですか。", romaji: "nihon wa dou desu ka.", en: "How is Japan?", group: "dining" },
  { kana: "すごい。", romaji: "sugoi.", en: "Amazing / great", group: "dining" },
  { kana: "あつい", romaji: "atsui", en: "hot (weather)", group: "dining" },
  { kana: "たべものはおいしい。", romaji: "tabemono wa oishii.", en: "The food is delicious", group: "dining" },
  { kana: "にほんははじめてですか。", romaji: "nihon wa hajimete desu ka.", en: "Is this your first time in Japan?", group: "dining" },
  { kana: "さんかいめです。", romaji: "sankai me desu.", en: "It's my third time", group: "dining" },
  { kana: "なんでこのあついじきにきたの。", romaji: "nande kono atsui jiki ni kita no.", en: "Why did you come in this hot season?", group: "dining" },
  { kana: "はじめてきたのはいつ。", romaji: "hajimete kita no wa itsu.", en: "When was your first time here?", group: "dining" },
  { kana: "えいごはなしますか。", romaji: "eigo hanashimasu ka.", en: "Do you speak English?", group: "dining" },
  { kana: "ゆっくり", romaji: "yukkuri", en: "slowly", group: "dining" },
  { kana: "うれしい", romaji: "ureshii", en: "happy / glad", group: "dining" },
  { kana: "しつもん", romaji: "shitsumon", en: "question", group: "dining" },
];
...
const PARTICLE_WORDS = [
  ...
  { kana: "かのじょ", romaji: "kanojo", en: "girlfriend / partner before marriage" },
  { kana: "かぞく", romaji: "kazoku", en: "family" },
  { kana: "にほんご", romaji: "nihongo", en: "Japanese language" },
  { kana: "しごと", romaji: "shigoto", en: "work / job" },
  { kana: "ソフトウェアエンジニア", romaji: "sofutowea-enjinia", en: "software engineer" },
  { kana: "フィリピンじん", romaji: "firipin-jin", en: "Filipino person" },
  { kana: "にほんじん", romaji: "nihon-jin", en: "Japanese person" },
  { kana: "ハーフ", romaji: "haafu", en: "half / mixed heritage" },
  { kana: "かいしゃ", romaji: "kaisha", en: "company / office" },
  { kana: "スタートアップ", romaji: "sutaato-appu", en: "startup" },
  { kana: "ジム", romaji: "jimu", en: "gym" },
  { kana: "こうえん", romaji: "kouen", en: "park" },
  { kana: "レストラン", romaji: "resutoran", en: "restaurant" },
  { kana: "としょかん", romaji: "toshokan", en: "library" },
  ...
  { kana: "もの", romaji: "mono", en: "thing / object" },
  ...
  { kana: "しゅうまつ", romaji: "shuumatsu", en: "weekend" },
  { kana: "げつようび", romaji: "getsuyoubi", en: "Monday" },
  { kana: "くがつ", romaji: "kugatsu", en: "September" },
  { kana: "とうきょう", romaji: "toukyou", en: "Tokyo" },
