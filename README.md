...
- **Kanji Fable** — a separate kanji-only track with drawing, adaptive quizzes, RTK-aligned primitive cues, shared local mnemonic notes, and one-round missed-card recovery ([`kanji.html`](kanji.html)).
