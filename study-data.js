window.JL_STUDY_SENTENCES = [
  ...
  {id:"build:particles:also-training",subject:"particles",en:"I like weightlifting too.",tokens:["ウェイトリフティング","も","すき","です。"]},
  {id:"build:particles:favorite-activity",subject:"particles",en:"My favorite thing is weightlifting.",tokens:["すきな","もの","は","ウェイトリフティング","です。"]},
  ...
  {id:"build:locations:gym-action",subject:"locations",en:"I lift at the gym.",tokens:["ジム","で","ウェイトリフティング","を","します。"]},
